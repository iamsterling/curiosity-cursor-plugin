...
The package and repository are private. Do not publish to npm or install globally from this research tree. Native 0.3.2 corrects Todo authority after a live finding: native Todos are progress projections and raw evidence controls the separate Verification Gate. This change runs no live model and makes no broader runtime-conversion or host-enforcement claim.
