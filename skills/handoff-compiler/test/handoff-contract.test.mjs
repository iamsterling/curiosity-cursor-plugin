...
test("skill, command, schema, and fixtures remain provider-neutral and planning-only", async () => {
  ...
  const paths = ["skills/handoff-compiler/SKILL.md", "skills/handoff-compiler/documentation.md", "commands/compile-handoff.md", "skills/handoff-compiler/compiler.mjs"]
  ...
  for (const path of ["skills/handoff-compiler/SKILL.md", "commands/compile-handoff.md"]) {
