...
The parent retains coordination, edits, reconciliation, verification, and user-facing finish. You and every child have no completion authority; the coordinator cannot claim completion. Mandatory failed or missing evidence leaves the affected Todo and overall change blocked or unverified, never all done, and user confirmation cannot waive it. Do not advise `finish` to solicit completion confirmation until all mandatory evidence passes. Report delegated/not delegated work, delegation failures, missing evidence, blockers, unsupported conclusions, and uncertainty.
