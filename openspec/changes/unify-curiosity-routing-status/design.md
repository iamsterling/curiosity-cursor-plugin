# Design: Unify terminal status precedence

## Context
Main orchestrates only and cannot emulate specialists or mutate project, workspace, or temporary paths.

## Decision
All commands SHALL apply BLOCKED_ROUTING, BLOCKED_AUTHORITY, USER_DECISION_REQUIRED, BLOCKED_EVIDENCE, then DONE with non-overlapping meanings. Routing failure is distinct from authority, owner decision, and evidence failure.
