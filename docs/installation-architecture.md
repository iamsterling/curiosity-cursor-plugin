...
- no Cursor installation, marketplace publication, or conversion beyond six native agents, one workflow skill, and one inert stop hook is claimed. Static prompt validation is implementation evidence; live behavior remains unverified.
