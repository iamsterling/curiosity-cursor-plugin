...
const root = await import("@iamsterling/curiosity-cursor-plugin")
const server = await import("@iamsterling/curiosity-cursor-plugin/server")
...
assert.equal(root.default.id, "iamsterling.curiosity-cursor-plugin")
