...
const compatibilityDispositions = {
 ...
 "loop-help":"manual-guidance:CURSOR_MAPPING_PENDING",
}
for(const file of files){
 ...
 const compatibilityDisposition=compatibilityDispositions[id] ?? (compatibility ? "unsupported:CURIOSITY_CURSOR_COMPAT_RUNTIME_UNSUPPORTED" : undefined)
