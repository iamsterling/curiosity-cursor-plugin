...
export const bundledAgentDefinitions = {
  ...
  researcher: {
    description:
      "Deep research, competitive landscape analysis, and reverse-engineering studies grounded in primary sources, with confidence-labeled findings and decision-ready verdicts.",
    mode: "subagent",
    system:
