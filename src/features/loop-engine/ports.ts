...
export interface LoopContinuationPort {
  continueParent(input: { readonly sessionID: string; readonly prompt: string; readonly promptID: string; readonly metadata: Readonly<Record<string, string>> }): Promise<void>;
